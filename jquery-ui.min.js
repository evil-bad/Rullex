...
(function(t) { "function" == typeof define && define.amd ? define(["jquery"], t) : t(jQueryChromeRuller) })(function(t) {
    ...
    t(document).on("mouseup", function() { s = !1 }), t.widget("ui.mouse", { version: "1.12.1", options: { cancel: "input, textarea, button, select, option", distance: 1, delay: 0 }, _mouseInit: function() { var e = this;
            ...
            n._zIndex && t(i.helper).css("zIndex", n._zIndex) } }), t.ui.draggable, t.widget("ui.resizable", t.ui.mouse, {
        version: "1.12.1",
        ...
        _hasScroll: function(e, i) { if ("hidden" === t(e).css("overflow")) return !1; var s = i && "left" === i ? "scrollLeft" : "scrollTop",
        ...
        _setOption: function(t, e) { switch (this._super(t, e), t) {
                case "handles":
        ...
        _mouseStart: function(e) { var i, s, n, o = this.options,
        ...
        _mouseDrag: function(e) { var i, s, n = this.originalMousePosition,
                o = this.axis,
                a = e.pageX - n.left || 0,
                r = e.pageY - n.top || 0,
        ...
        _mouseStop: function(e) { this.resizing = !1; var i, s, n, o, a, r, l, h = this.options,
        ...
        _updateRatio: function(t) { var e = this.position,
                i = this.size,
        ...
        _respectSize: function(t) { var e = this._vBoundaries,
                i = this.axis,
        ...
        _renderProxy: function() { var e = this.element,
                i = this.options;
            this.elementOffset = e.offset(), this._helper ? (this.helper = this.helper || t("<div style='overflow:hidden;'></div>"), this._addClass(this.helper, this._helper), this.helper.css({ width: this.element.outerWidth(), height: this.element.outerHeight(), position: "absolute", left: this.elementOffset.left + "px", top: this.elementOffset.top + "px", zIndex: ++i.zIndex }), this.helper.appendTo("body").disableSelection()) : this.helper = this.element },
        _change: { e: function(t, e) { return { width: this.originalSize.width + e } }, w: function(t, e) { var i = this.originalSize,
    ...
    }), t.ui.plugin.add("resizable", "animate", { stop: function(e) { var i = t(this).resizable("instance"),
                s = i.options,
